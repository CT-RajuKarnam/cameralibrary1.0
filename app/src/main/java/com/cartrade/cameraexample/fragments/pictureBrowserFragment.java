...
import com.cartrade.cameraexample.images.utils.imageIndicatorListener;
import com.cartrade.cameraexample.images.utils.pictureFacer;
import com.cartrade.cameraexample.images.utils.recyclerViewPagerImageIndicator;
...
public class pictureBrowserFragment extends Fragment implements imageIndicatorListener {
    ...
    private class ImagesPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(@NonNull ViewGroup containerCollection, int position) {
           ...
           /* if(pic.getPicturePath().contains(".mp4")){
                try {
                    final Bitmap bitmap2 = ThumbnailUtils.createVideoThumbnail(pic.getPicturePath(), MediaStore.Video.Thumbnails.MINI_KIND);
                    new Handler().postDelayed(new Runnable() {
                        ...
                        public void run() {
                            if (bitmap2 != null) {
                                ...
                                image.setImageDrawable(animeContx.getResources().getDrawable(R.drawable.box_black));
                            }
                        }
                    }, 1500);
                }catch (Exception e){
