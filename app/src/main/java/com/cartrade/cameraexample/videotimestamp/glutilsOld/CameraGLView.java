package com.cartrade.cameraexample.videotimestamp.glutilsOld;
/*
...
public final class CameraGLView extends GLSurfaceView {
    ...
    public static String mDesiredFlash;
...
//********************************************************************************
    ...
    private static FullFrameRect mFullScreenOverlay;
    public static int mOverlayTextureId = -1;
...
//			if (DEBUG) Log.i(TAG, "onSurfaceCreated:Gl extensions: " + extensions);
            ...
            hTex = mFullScreen.createTextureObject();
        ...
        public void onDrawFrame(final GL10 unused) {
            ...
            try {
                mOverlayTextureId = createTextureWithTextContentNew(getCurrentDate(), mContext, mOverlayTextureId);
                if (mFullScreenOverlay == null)
                    mFullScreenOverlay = new FullFrameRect(
                            new Texture2dProgram(Texture2dProgram.ProgramType.TEXTURE_2D));
            ...
            if (mFullScreen != null)
                mFullScreen.drawFrame(hTex, mStMatrix);
...
//					}
        ...
        public static void requestFlash(String desiredFlash) {
            ...
            try {
                ...
                if (isValidFlashMode(flashModes, mDesiredFlash)) {
                    mDesiredFlash = null;
                    try {
                        params.setFlashMode(desiredFlash);
                        mCamera.setParameters(params);
        ...
        private static boolean isValidFlashMode(List<String> flashModes, String flashMode) {
...
//			params.setRotation(degrees);
    ...
    public static int createTextureWithTextContentNew(String text, Context context, int mOverlayTextureId) {
        ...
        if (AdroitApplication.lat != 0 & AdroitApplication.lng != 0) {
        ...
        return loadTexture(bitmap, mOverlayTextureId, true);
    }
