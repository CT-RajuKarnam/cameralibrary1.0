...
//        handler = new CameraHandler(getLooper(), uiCallback);
    ...
    private static final class CameraHandler extends Handler {
        ...
        private void processBitmap(final Camera1 camera1, byte[] data) throws RuntimeException {
            try {
                Log.e("Unrecognized", "Unrecognized Memory" + data.length);
                ...
                throw new RuntimeException("Unknown Action In CameraHandlerThread: " + e.getMessage());
            }
        }
    }
}
